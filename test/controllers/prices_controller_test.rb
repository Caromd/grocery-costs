...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { amount: @price.amount, date_bought: @price.date_bought, item_id: @price.item_id }
    end
  ...
  test "should update price" do
    patch :update, id: @price, price: { amount: @price.amount, date_bought: @price.date_bought, item_id: @price.item_id }
    assert_redirected_to price_path(assigns(:price))
  end
